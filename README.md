<div align="center">
  ...
  ![New Project](https://github.com/user-attachments/assets/db77ed31-405d-4b6e-aeff-cfbf226d6c33)
  ...
  <a href="https://discord.gg/MPuQEeZB4w"><img src="https://img.shields.io/discord/927329821405642772?color=0098DB&label=Discord&logo=discord&logoColor=0098DB"></a>
  
  Brewing guide is a minecraft fabric mod that allows you to see a menu with all of the potion recipes ingame instead of having to search for them on the internet all the time.
</div>

## Sources
- [Discord](https://discord.gg/MPuQEeZB4w)
- [Modrinth](https://modrinth.com/project/brewing-guide-mod)
- [Github](https://github.com/Ceymikey/brewing-guide)

## Preview

![v3scv5_1](https://github.com/user-attachments/assets/68b6ed1d-d793-45cc-ae67-ed33cdef817c)
